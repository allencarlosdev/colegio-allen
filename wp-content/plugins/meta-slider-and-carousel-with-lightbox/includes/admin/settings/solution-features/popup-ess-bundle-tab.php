...
<div id="igsp_unlock_tabs" class="igsp-vtab-cnt igsp_unlock_tabs igsp-clearfix">
	...
	<!-- <div style="text-align: center;">
		<img style="width: 100%; margin-bottom:30px;" src="<?php // echo esc_url( WP_IGSP_URL ); ?>assets/images/image-upgrade.png" alt="image-upgrade" title="image-upgrade" />
	</div> -->
	...
	<div class="igsp-deal-offer-wrap">
		<div class="igsp-deal-offer"> 
			...
			<div class="igsp-inn-deal-offer-btn">
				...
				<a href="<?php echo WP_IGSP_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="igsp-sf-btn igsp-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Get Essential Bundle Now</a>
			</div>
		</div>
	</div>
</div>