...
if( ! defined( 'WP_IGSP_VERSION' ) ) {
	define( 'WP_IGSP_VERSION', '1.8.2' ); // Version of plugin
}

if( ! defined( 'WP_IGSP_NAME' ) ) {
	define( 'WP_IGSP_NAME', 'Meta slider and carousel with lightbox' ); // Version of plugin
}
...
if( ! defined( 'WP_IGSP_PLUGIN_LINK_UNLOCK' ) ) {
	define( 'WP_IGSP_PLUGIN_LINK_UNLOCK','https://www.essentialplugin.com/wordpress-plugin/meta-slider-carousel-lightbox/?utm_source=WP&utm_medium=Meta-Slider&utm_campaign=Features-PRO#wpos-epb' ); // Plugin link
}

if( ! defined( 'WP_IGSP_PLUGIN_LINK_UPGRADE' ) ) {
	define( 'WP_IGSP_PLUGIN_LINK_UPGRADE','https://www.essentialplugin.com/pricing/?utm_source=WP&utm_medium=Meta-Slider&utm_campaign=Upgrade-PRO#wpos-epb' ); // Plugin Check link
}
